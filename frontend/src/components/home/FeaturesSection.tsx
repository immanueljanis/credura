  ...
  const features = [
    {
      ...
      description: 'All certificates and achievements are stored on-chain for permanent verification',
      color: 'bg-[#58CC02]'
    },
    {
      icon: Gift,
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold text-gray-900 mb-4">
            Why Choose Digital Campus?
          </h2>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Experience the future of education with blockchain-powered learning that rewards your progress
          </p>
        </div>
