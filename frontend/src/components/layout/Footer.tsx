        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-400 mb-6 max-w-md">
              ...
              innovative education and hands-on learning experiences.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/quiz" className="text-gray-400 hover:text-[#58CC02] transition-colors">
                  Quiz
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/help" className="text-gray-400 hover:text-[#58CC02] transition-colors">
                  Help Center
                </Link>
              </li>
              <li>
