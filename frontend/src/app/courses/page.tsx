...
const COURSES = [
  {
    ...
    description: 'Master the basics of blockchain technology and cryptocurrency. Learn about consensus mechanisms, mining, and the underlying principles.',
  ...
  },
  {
    ...
    description: 'Learn to build and deploy smart contracts on Ethereum using Solidity programming language and development frameworks.',
  ...
  },
  {
    ...
    description: 'Advanced concepts in decentralized finance and protocol design. Build your own DeFi applications from scratch.',
  ...
  },
  {
    ...
    description: 'Build your own NFT marketplace from scratch using React, Web3.js, and smart contracts.',
  ...
  },
  {
    ...
    description: 'Learn technical analysis, risk management, and trading strategies for cryptocurrency markets.',
  ...
  },
  {
    ...
    description: 'Complete full-stack development course covering frontend, backend, and blockchain integration.',
